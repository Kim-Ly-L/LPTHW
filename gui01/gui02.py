...
from PyQt5.QtGui import QPixmap # internal representation of an image
import sys
...
class MyWindow(QWidget):
    ...
    def initGUI(self):
        ...
        self.setGeometry(10, 10, pixrect.width(), pixrect.height() + 50) # 10,10 --> position of the window
